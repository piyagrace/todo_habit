...
const Update = () => {
    ...
    const handleUpdate = async () => {
        try {
            ...
            const response = await axios.put(`http://localhost:3001/todos/${todoId}`, updatedTodoData);
            ...
            if (error.response && error.response.data && error.response.data.error) {
                ...
                Alert.alert("Error", "There was a problem updating your Todo");
            }
        }
    };
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Pressable onPress={handleUpdate} style={[styles.saveButton, styles.saveButtonRow]}>
